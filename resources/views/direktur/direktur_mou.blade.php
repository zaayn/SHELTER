            ...
            <div class="panel block">
                <div class="panel-body">
                    ...
                    <div style="float:right; margin-bottom:10px;">
                        <a href="{{asset('/direktur/mou/exportExcel')}}" class="btn btn-default btn-sm" target="_blank">Download Excel</a>
                        <a href="{{asset('/direktur/mou/exportPDF')}}" class="btn btn-default btn-sm" target="_blank">Download PDF</a>
                    </div>
