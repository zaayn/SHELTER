    ...
    <div class="col-md-12">
        <div class="panel block">
            <div class="panel-body">
                ...
                <ol class="breadcrumb">
                    <li><a href="{{asset('/officer/home')}}"><i class="fa fa-dashboard"></i> Home</a></li>
            ...
            <div class="panel block">
                <div class="panel-body">
                            ...
                            <div style="float:right; margin-bottom:10px;">
                                {{-- <a href="{{asset('/officer_crm/insertkontrak')}}" class="btn btn-primary btn-sm">Insert Kontrak</a> 
                                <a href="{{asset('/officer_crm/kontrak/exportPDF')}}" class="btn btn-default btn-sm" target="_blank">Download PDF</a> --}}
                            </div> 
