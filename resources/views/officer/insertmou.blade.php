                ...
                <form action="{{route('store.mou')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group col-md-6">
                	        ...
                	        <input type="date" class="form-control" name="mf" required>
                        </div>
                        <div class="form-group col-md-6">
                	        <label class="font-weight-bold">MF (%)</label>
                        ...
                        <div class="form-group col-md-6">
                	        ...
                	        <input type="date" class="form-control" name="bpjs_tenagakerja">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                	        ...
                	        <input type="date" class="form-control" name="jiwasraya">
                        </div>
                        <div class="form-group col-md-6">
                	        <label class="font-weight-bold">Ramamusa</label>
                	        <input type="text" class="form-control" name="ramamusa">
                        </div>
                        <div class="form-group col-md-6">
                	        <label class="font-weight-bold">Ditagihkan</label>
                	        <input type="date" class="form-control" name="ditagihkan">
                        </div>
                        <div class="form-group col-md-6">
                	        <label class="font-weight-bold">Diprovisasikan</label>
                	        <input type="text" class="form-control" name="diprovisasikan">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                	        ...
                	        <input type="date" class="form-control" name="training" required>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                	        ...
                	        <input type="date" class="form-control" name="kaporlap" required>
                        </div>
                        <div class="form-group col-md-6">
