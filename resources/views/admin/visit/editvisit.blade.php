                ...
                <form action="{{route('update.visit', $visit->visit_id)}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group col-md-12">
                	        ...
                	        <input type="time" class="form-control timepicker" name="waktu_in" value="{{ $visit->waktu_in }}" required>
                        </div>
                        <div class="form-group col-md-12">
                	        <label class="font-weight-bold">Waktu Out</label>
                	        <input type="time" class="form-control timepicker" name="waktu_out" value="{{ $visit->waktu_out }}" required>
                        </div>
                        <div class="form-group col-md-12">
