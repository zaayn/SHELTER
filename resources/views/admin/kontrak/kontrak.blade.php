                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(!isset($kontrak->datamou->id_kontrak))
                                            <a href="{{route('insertmou.kontrak',$kontrak->id_kontrak)}}" class="btn btn-default btn-sm"data-toggle="tooltip" data-placement="right" title="Tambah MoU">Tambah MoU</span></a>
