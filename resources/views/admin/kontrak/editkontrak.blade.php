                  ...
                  <form action="{{route('update.kontrak', $kontrak->id_kontrak)}}" method="post">
                    ...
                    <div class="form-group">
                        <div class="form-group col-md-12">
                	        ...
                	        <input type="text" class="form-control" disabled="disabled" name="nomor_kontrak" value="{{$kontrak->nomor_kontrak}}" required>
                        </div>
                        <div class="form-group col-md-12">
                        ...
                        <div class="form-group col-md-12">
                	        ...
                	        <input type="date" disabled="disabled" class="form-control disabled" name="periode_kontrak" value="{{ $kontrak->periode_kontrak }}" required>
                        </div>
                        <div class="form-group col-md-12">
