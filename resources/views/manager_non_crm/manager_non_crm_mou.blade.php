...
<div class="row">
        <div class="col-md-12">
            <div class="panel block">
                <div class="panel-body">
                    {{-- ----------  -------------- filter ------------------------ --}}
                    <form class="form-horizontal" id="form-filter" method="POST" action="{{route('filter.mou.noncrm')}}">
                            @csrf
                    ...
                    <div style="float:right; margin-bottom:10px;">
                        <a href="{{asset('/manager_non_crm/mou/exportExcel')}}" class="btn btn-default btn-sm" target="_blank">Download Excel</a>
                        <a href="{{asset('/manager_non_crm/mou/exportPDF')}}" class="btn btn-default btn-sm" target="_blank">Download PDF</a>
                    </div>
                            ...
                            <table id="mydatatables" class="table table-collapse table-hover table-light table-striped cell-border table-responsive">                                <thead>
                                ...
                                <tr>
                                    ...
                                    <td>{{ number_format($datamou->bpjs_tenagakerja, 2, ',','.') }}</td>
                                    <td>{{ $datamou->bpjs_kes_persen ?$datamou->bpjs_kes_persen.'%':'' }}</td>
                                    <td>{{ number_format($datamou->bpjs_kesehatan, 2, ',','.') }}</td>
                                    <td>{{ number_format($datamou->jiwasraya, 2, ',','.') }}</td>
                                    <td>{{ number_format($datamou->ramamusa, 2, ',','.') }}</td>
